...
export default function RoomsFilter() {
    ...
    const {handleChange,type,capacity,minSize,maxSize,price,minPrice,maxPrice,breakfast,pets,rooms}=context;
    //get type
            ...
            <form className="filter-form">
                <div className="form-group">
                    <label htmlFor="type">Room Type</label>
                        <select name="type" id="type" value={type} onChange={handleChange}>{types}</select>
                    
                </div>
                <div className="form-group">
                    <label htmlFor="capacity">Guests</label>
                        <select name="capacity" id="capacity" value={capacity} onChange={handleChange}>{people}</select>
                </div>
                ...
                <div className="form-group">
                    <div className="single-extra">
                        ...
                        id="breakfast" checked={breakfast} onChange={handleChange} ></input>
